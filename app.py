...
from romania_map import bfs, dfs, ucs, romania_map
import random
import os

app = Flask(__name__)

# Coordinates for each city on the map image (example values; adjust for your map)
city_coords = {
    "Arad": (100, 150),
    "Zerind": (120, 100),
    "Oradea": (140, 80),
...
def home():
    ...
    start, end = random.sample(cities, 2)  # Random default
